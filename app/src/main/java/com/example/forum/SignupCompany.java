                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            Toast.makeText(SignupCompany.this,"Picture can't be uploaded change picture please !",Toast.LENGTH_SHORT).show();
                        }
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(SignupCompany.this,"Multipart file prob !",Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
...
*/
    ...
    private void saveprofile(JSONObject photo_infos){
        String url2="http://192.168.68.1:8080/api/auth/signupCompany";
        ...
        final  String annee_setting = this.profiletype.getText().toString().trim();
        final  String filliere_setting = this.profileaddress.getText().toString().trim();
        ...
        try {
            ...
            Toast.makeText(SignupCompany.this,"Json object didn't get inside" ,Toast.LENGTH_SHORT).show();
            e.printStackTrace();
        }
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            Toast.makeText(SignupCompany.this,"Your profile has been created : " + message ,Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(SignupCompany.this,Login.class);
                            startActivity(intent);


                        }catch (JSONException e){
                            Toast.makeText(SignupCompany.this,"There is a problem with the data inserted !",Toast.LENGTH_SHORT).show();
                        }
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(SignupCompany.this,"Error Check your connection !",Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
            protected Map<String , String> getParams(){
